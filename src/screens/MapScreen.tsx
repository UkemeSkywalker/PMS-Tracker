  ...
  return <View style={styles.screen}>
    ...
    <View style={styles.mapArea} onLayout={event => setMapHeight(event.nativeEvent.layout.height)}>
      ...
      <View style={styles.mapControls}>
        ...
        {Platform.OS !== 'android' && <Pressable accessibilityLabel="Toggle traffic" onPress={() => setTraffic(current => !current)} style={styles.mapControl}><Ionicons name="car-outline" size={21} color={traffic ? colors.blue : colors.navy} /></Pressable>}
      </View>
